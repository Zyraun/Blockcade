...
public class AdventureCmd implements CommandExecutor {
    ...
    /**
     * Sets players game-mode to Adventure mode
     * Notifies player of game-mode update
     *
     * @param player the player to set to Adventure
     */
    ...
    /**
     * Set yourself or other players into Adventure mode
    ...
    public boolean onCommand(CommandSender s, Command cmd, String label, String[] args) {
        if (cmd.getName().equalsIgnoreCase("adventure")) {
            ...
            if (args.length == 0) {
                ...
                s.sendMessage(ChatColor.GRAY + "Updated " + targetPlayer.getName() + " gamemode to adventure mode.");
            } else {
