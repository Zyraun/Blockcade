...
public class SurvivalCmd implements CommandExecutor {
    ...
    /**
     * Sets players game-mode to Survival mode
     * Notifies player of game-mode update
     *
     * @param player the player to set to Survival
     */
    ...
    /**
     * Set yourself or other players into Survival mode
    ...
    public boolean onCommand(CommandSender s, Command cmd, String label, String[] args) {
        if (cmd.getName().equalsIgnoreCase("survival")) {
            ...
            if (args.length == 0) {
                ...
                s.sendMessage(ChatColor.GRAY + "Updated " + targetPlayer.getName() + " gamemode to survival mode.");
            } else {
